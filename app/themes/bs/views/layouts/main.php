...
<script src="<?=Yii::app()->theme->viewPath?>/js/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="<?=Yii::app()->theme->viewPath?>/js/jquery.fileupload.js"></script>
<!-- The File Upload image processing plugin -->
<script src="<?=Yii::app()->theme->viewPath?>/js/jquery.fileupload-ip.js"></script>
<!-- The File Upload user interface plugin -->
<script src="<?=Yii::app()->theme->viewPath?>/js/jquery.fileupload-ui.js"></script>
<!-- The localization script -->
<script src="<?=Yii::app()->theme->viewPath?>/js/locale.js"></script>
<!-- The main application script -->
<script src="<?=Yii::app()->theme->viewPath?>/js/main.js"></script>
<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE8+ -->
<!--[if gte IE 8]>
<script src="<?=Yii::app()->theme->viewPath?>/js/cors/jquery.xdr-transport.js"></script><![endif]-->
</body>
</html>
